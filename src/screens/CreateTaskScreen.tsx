...
import { Modal, Portal, Card, TextInput, Title, Button, Menu, useTheme, HelperText } from 'react-native-paper'
...
export function CreateTaskModal({ isCreateTaskScreenVisible, setCreateTaskScreenVisible, projectID }: Types.CreateTaskModalProps_T) {
    ...
    useEffect(() => {
        ...
        setSelectedPriority(2);
        setTitleError(false);
    }, [isCreateTaskScreenVisible]); //resets relevant variables every time modal is opened
    ...
    return (
        ...
        >
            <Portal>
                <Modal
                    visible={isCreateTaskScreenVisible}
                    onDismiss={() => setCreateTaskScreenVisible(false)}
                    ...
                    <Card mode={"contained"} style={{ width: "100%" }}>
                        <Card.Content>
                            ...
                            <TextInput
                                ...
                                style={{ marginTop: -9, maxHeight: 200 }}
                            />
                        ...
                        <Card.Actions style={{ marginTop: 35 }}>
                            <Button textColor={colors.onPrimaryContainer}
                                ...
                                onPress={() => {
                                    ...
                                    setCreateTaskScreenVisible(false);
                                }}>Create Task</Button>
                        </Card.Actions>
                    </Card>
                </Modal>
